...
Software dependencies remain subject to their respective upstream licenses. Dependency metadata and automated license checks should be added during implementation.
