...
function mapPalette(p: VendorPalette, mode: "light" | "dark"): ColorTokens {
  ...
  return {
    ...
    // The kit has no glass: tinted "glass" resolves to the same solid soft tint with a firmer border.
    "accent.brand": p.brand,
    "accent.brand.visual": p.brand,
    "accent.brand.soft": soft(p.brand),
    "accent.brand.glass": soft(p.brand),
    "accent.brand.glass.border": withAlpha(p.brand, 0.4),
    "accent.feeding": p.coral,
    "accent.feeding.visual": p.coral,
    "accent.feeding.soft": soft(p.coral),
    "accent.feeding.glass": soft(p.coral),
    "accent.feeding.glass.border": withAlpha(p.coral, 0.4),
    "accent.play": p.success,
    "accent.play.visual": p.success,
    "accent.play.soft": soft(p.success),
    "accent.play.glass": soft(p.success),
    "accent.play.glass.border": withAlpha(p.success, 0.4),
    "accent.sleep": p.violet,
    "accent.sleep.visual": p.violet,
    "accent.sleep.soft": soft(p.violet),
    "accent.sleep.glass": soft(p.violet),
    "accent.sleep.glass.border": withAlpha(p.violet, 0.4),
    "accent.safety": p.rose,
    "accent.safety.visual": p.rose,
    "accent.safety.soft": soft(p.rose),
    "accent.safety.glass": soft(p.rose),
    "accent.safety.glass.border": withAlpha(p.rose, 0.4),
    "accent.tools": p.teal,
    "accent.tools.visual": p.teal,
    "accent.tools.soft": soft(p.teal),
    "accent.tools.glass": soft(p.teal),
    "accent.tools.glass.border": withAlpha(p.teal, 0.4),
