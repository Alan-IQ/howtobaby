...
export const babyModernGlassDark: ColorTokens = {
  ...
  // Dark mode keeps its current character: the label tones are already the bright domain colours, so
  // the non-text `accent.*.visual` markers map to the same values (no separate visual ramp needed).
  "accent.brand": "#9aa6f5",
  "accent.brand.visual": "#9aa6f5",
