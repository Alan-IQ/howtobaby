...
export function EvidenceDrawer({
  ...
  onClose,
  title,
  attribution = "This guidance is written by HowToBaby and supported by the original sources listed below. The wording is HowToBaby’s, not a direct quote from these organizations.",
  claimText,
