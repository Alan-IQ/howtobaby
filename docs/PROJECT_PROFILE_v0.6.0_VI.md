...
> Bản tiếng Việt dùng để đọc/review. **Bản English `PROJECT_PROFILE_v0.6.0.md` là canonical cho implementation.** HowToBaby được định nghĩa là nền tảng **evidence-to-action + parent utilities**, không chỉ là trang kiến thức.
