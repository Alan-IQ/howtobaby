...
Ranh giới giai đoạn vẫn dùng khoảng nửa mở `[min,max)` trong logic nội bộ, nhưng nội dung hiển thị cho phụ huynh phải diễn đạt bằng ngôn ngữ thông thường thay vì ký hiệu khoảng. Ví dụ: “dưới 4 tháng”, “từ 4 đến dưới 6 tháng” và “khoảng 6 đến dưới 8 tháng”. UI không được hiển thị các dạng như “4–<6 tháng” hoặc “~6–<8 tháng”. Cách diễn đạt này dùng thống nhất ở mọi nơi hiển thị khoảng tuổi của giai đoạn cho phụ huynh: tiêu đề trang và metadata, chip của bộ điều hướng giai đoạn cùng tooltip `title`, WhyThisStage, ChildSummary, PreviewPlanDate và liên kết giai đoạn trước/sau. Route slug (`/feeding/6-8-months`) giữ nguyên.
