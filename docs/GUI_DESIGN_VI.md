...
Giai đoạn đang xem mang aria-current="page". Ở chế độ sáng, chip dùng nền kính pha màu của chủ đề, chữ bằng màu accent an toàn cho văn bản và viền kính tương ứng; ở chế độ tối, chip vẫn dùng nền accent đặc của chủ đề với text.on-accent. Nếu giai đoạn đang xem cũng là giai đoạn hiện tại của bé, viền màu thương hiệu vẫn là dấu hiệu nhận biết giai đoạn thực tế và chấm tròn dùng cùng màu với chữ đang chọn để luôn rõ trên nền kính sáng.
