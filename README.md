...
**v0.8.0 — Phase 0 (repository baseline), Phase 1 (app shell + theme engine), Phase 2 (content/source schema platform) and Phase 3 (age/context + browse/public routing) implemented; Phase 4+ (domain content, the personalized Now composer, tools, Evidence Watch) not yet started.**
